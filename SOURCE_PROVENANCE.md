...
| PyCryptodome | Test-vector generation only | Installed from `test/requirements.txt`; not included in synthesizable RTL | Dependency version pinned; licence notice review remains part of release packaging |
